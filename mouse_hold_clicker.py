import tkinter, customtkinter, keyboard, threading, time, sys
...
class MouseApp:
    ...
    def create_hold_mouse_page(self):
        ...
        # Remove existing key event listeners
        keyboard.unhook_all()
        ...
        label = customtkinter.CTkLabel(self.root, text="Hold Mouse", font=(None, 30))
    ...
    def create_mouse_clicker_page(self):
        ...
        label = customtkinter.CTkLabel(self.root, text="Mouse Clicker", font=(None, 30))
        label.grid(row=1, column=0, sticky='nsew', columnspan=2, padx=10, pady=(0, 75))
